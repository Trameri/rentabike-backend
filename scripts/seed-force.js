...
async function run(){
  ...
  console.log('🔥 SEED FORZATO - CANCELLAZIONE COMPLETA DEL DATABASE...');

  // Pulisci TUTTI i dati (inclusi i contratti)
  await Promise.all([
    Location.deleteMany({}), 
    User.deleteMany({}),
    Bike.deleteMany({}),
  ...
  console.log('⚠️ TUTTI I DATI PRECEDENTI SONO STATI CANCELLATI!');
